...
$(function () {
  ...
  timeBlocks.each(function(){
    ...
    //check if the time block is in the present
  ...
  timeBlocks.each(function(){
    ...
    let textAreaValue = localStorage.getItem(timeBlockId);
    $(this).children("textarea").val(textAreaValue);
  })

  //
  // TODO: Add code to display the current date in the header of the page.
  // HINT: How can Day.js be used to get the current date?
    currentDay.text(currentDate);
